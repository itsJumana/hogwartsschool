...
ActiveRecord::Schema[7.1].define(version: 2024_11_03_174506) do
  create_table "administrators", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["wizard_id"], name: "index_administrators_on_wizard_id"
  end
  ...
  add_foreign_key "administrators", "wizards"
